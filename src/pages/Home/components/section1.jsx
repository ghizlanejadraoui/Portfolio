...
export const FirstSectionHome = () => {
  ...
  return (
    <>
      {/* SECTION 1 */}
      <div className='firstsc h-[100vh]  w-full  firstdiv bg-gradient-to-tr from-brown-700 to-brown-100 mt-[3rem]' id='home'>
        <div className="flex flex-wrap justify-between align-items-center text-center p-4">
          ...
          <div className=" w-50  mt-[2vh] flex justify-center  ">
      ...
      {/* FIN SECTION 1 */}
      {/* SECTION 2 */}
      <section data-aos="fade-up" className=' bg-white/50 h-[170vh] w-full  flex flex-col justify-evenly ' id='skills'>
      ...
      {/* section 3 */}
      <section>
        <section className="allsectionimg d-flex flex-column justify-content-evenly w-full bg-gradient-to-tr from-brown-900 to-brown-200 " id='Projects'>
          {/* <!--&&&&&&&  --> */}
      ...
      {/* fin section 3 */}
      {/* section 4 */}
      <div className='firstsc h-[111vh]  w-full  firstdiv bg-white ' id='Contact'>
        <div className="flex flex-wrap justify-between align-items-center text-center p-4">
          <div className=" w-50 text-black" data-aos="fade-right">
            <section>
